    ...
    def _setup_sionna_components(self):
        ...
        try:
            ...
            self.channel_model = sn.channel.RayleighBlockFading(
                num_rx_ant=self.system_params.num_rx_antennas,  # Changed from num_rx to num_rx_ant
                num_tx_ant=self.system_params.num_tx_antennas,  # Changed from num_tx to num_tx_ant
                dtype=tf.complex64
            )
